...
struct ContentView: View {
    ...
    let symbols = ["gfx-bell", "gfx-seven", "gfx-cherry", "gfx-coin", "gfx-strawberry", "gfx-grape"]
        ...
        ZStack {
            ...
            VStack(alignment: .center, spacing: 5) {
                ...
                VStack(alignment: .center, spacing: 0) {
                    ...
                    Button(action: {
                        // 1. Set the deafault state: no animation
                        withAnimation {
                        ...
                        // 3. Trigger the animation after chaning the symbols
                        withAnimation {
                ...
                HStack {
                    ...
                    HStack(alignment: .center, spacing: 10) {
                        ...
                        Image("gfx-casino-chips")
                            .resizable()
                            .offset(x: isActiveBet20 ? 0 : 20) // moves the chips from left to right
                    ...
                    HStack(alignment: .center, spacing: 10) {
                        Image("gfx-casino-chips")
                            .resizable()
                            .offset(x: isActiveBet10 ? 0 : -20) // moves the chips from right to left
